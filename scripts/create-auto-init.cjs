...
const autoInitScript = `// GhostComplete Auto-Initialization Script
...
// Write the auto-init script to the root directory
fs.writeFileSync(path.join(__dirname, '..', 'auto-init.js'), autoInitScript);

console.log('Auto-initialization script created successfully!');